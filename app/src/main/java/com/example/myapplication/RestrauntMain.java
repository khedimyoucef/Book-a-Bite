...
public class RestrauntMain extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_restraunt_main);

        vibrator = (Vibrator) getSystemService(Context.VIBRATOR_SERVICE);
        bottomNavigationView = findViewById(R.id.bottom_nav_bar);
        currentFragment = new restaurantBookingFragment();
        ...
        bottomNavigationView.setOnItemSelectedListener(new NavigationBarView.OnItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (itemId == R.id.home) {
                    ...
                    fragment = new restaurantBookingFragment();
                } else if (itemId == R.id.table) {
                    fragment = new restaurantTablesFragment();
